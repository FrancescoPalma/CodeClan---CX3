...
class Match
  ...
  def home_win
    @home_team_score > @away_team_score && @home_team_score != @away_team_score ? true : false
  end

  def away_win
    @away_team_score > @home_team_score && @away_team_score != @home_team_score ? true : false
  end

  def both_draw
    @home_team_score == @away_team_score ? true : false
  end
